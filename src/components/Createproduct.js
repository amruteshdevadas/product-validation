//component used to add a new product
...
function Createproduct(props) {
  ...
  function handleSubmit(e) {
    productContext.productList.push(e);

    history.push("/");
  }
  //defining state of each input value
  ...
  //validation scheme for entered values
